import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{r as f,a as b,o as g,i}from"./footer-C9JiiZp_.js";import{r as y,e as s}from"./renderCard-CqHj5xky.js";import{i as h,t as $,a as E}from"./favoritesStore-BcMbUSNM.js";import{a as L,g as v,c as S,r as I}from"./eventsService-DxdUnzle.js";import"./firebase-config-CWLAEKZD.js";import"./index.esm2017-DMBRuzyj.js";f("events");b();const o=document.getElementById("event-details-mount"),m=new URLSearchParams(location.search).get("id");let e=null,n=null,a=!1;h(()=>{e&&u()});g(async t=>{n=t,e&&t&&(a=await v(e.id,t.uid),c())});async function B(){if(!m){p();return}if(e=await L(m),!e){p();return}n&&(a=await v(e.id,n.uid)),R()}function p(){o.innerHTML="",y(o,{title:"This event isn't available",description:"It may have been removed or already taken place."});const t=document.createElement("div");t.style.textAlign="center",t.innerHTML='<a href="/events.html" style="color:#7c3aed;text-decoration:underline;font-size:13px;">Back to Campus Events</a>',o.appendChild(t)}function R(){const t=w(e);o.innerHTML=`
